...
const TrackService = () => {
  ...
  return (
    <div className="track-service-page">
      ...
      <section className="page-hero hero-tracking">
        <div className="container">
          ...
          <h1 className="section-title">Track Your Repair</h1>
            ...
            <div className="track-details-grid">
              <div className="details-card-left">
                ...
                <div className="detail-row">
                  ...
                  <div className="detail-val track-detail-issue-box">
                    "{ticketDetails.issue}"
                  </div>
                </div>
